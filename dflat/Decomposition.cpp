...
void Decomposition::printGraphMl(std::ostream& out, bool graphml) const
{
	if (!graphml)
		printAspElements(out);
	else {
...
void Decomposition::printAspElements(std::ostream& out) const
{
